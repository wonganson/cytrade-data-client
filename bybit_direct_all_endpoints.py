"""
Example: fetch every known bybit-direct endpoint. Uses the gateway's own catalog
(GET /v1/providers/bybit-direct/endpoints, via fetcher.endpoints()) as the source of
...
PROVIDER = "bybit-direct"
now = int(time.time() * 1000)
one_week_ago = now - 3* 52 * 24 * 3600 * 1000
