...
This isn't published anywhere (no PyPI, no registry) — while developing against a
local `cytrade-data` checkout, install it editable so changes are picked up without
reinstalling:
